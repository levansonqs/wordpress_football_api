...
add_action( 'widgets_init', 'news_portal_register_ads_banner_widget' );

function news_portal_register_ads_banner_widget() {
...
class News_Portal_Ads_Banner extends WP_widget {
    ...
    public function __construct() {
        $widget_ops = array( 
            ...
            'description' => __( 'You can place banner as advertisement with links.', 'news-portal' )
        );
        parent::__construct( 'news_portal_ads_banner', __( 'NP: Ads Banner', 'news-portal' ), $widget_ops );
    }
