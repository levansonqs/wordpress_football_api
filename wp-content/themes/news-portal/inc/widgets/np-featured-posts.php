...
add_action( 'widgets_init', 'news_portal_register_featured_widget' );

function news_portal_register_featured_widget() {
    ...
    private function widget_fields() {
        ...
        $fields = array(
            ...
            'block_title' => array(
                ...
                'news_portal_widgets_description'  => __( 'Enter your block title. (Optional - Leave blank to hide title.)', 'news-portal' ),
