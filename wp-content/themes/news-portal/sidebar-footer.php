...
if( !is_active_sidebar( 'news_portal_footer_sidebar' ) &&
	!is_active_sidebar( 'news_portal_footer_sidebar-2' ) &&
    !is_active_sidebar( 'news_portal_footer_sidebar-3' ) &&
    !is_active_sidebar( 'news_portal_footer_sidebar-4' ) ) {
	   return;
}
        ...
        <div class="footer-widgets-area np-clearfix">
            <div class="np-footer-widget-wrapper np-column-wrapper np-clearfix">
          		<div class="np-footer-widget wow fadeInLeft" data-wow-duration="0.5s">
          			<?php
              			if ( !dynamic_sidebar( 'news_portal_footer_sidebar' ) ):
              			endif;
          			?>
          		</div>
                ...
                <div class="np-footer-widget wow fadeInLeft" data-woww-duration="1s">
          		    <?php
          			if ( !dynamic_sidebar( 'news_portal_footer_sidebar-2' ) ):
          			endif;
          			?>
          		</div>
                <?php } ?>
                ...
                <div class="np-footer-widget wow fadeInLeft" data-wow-duration="1.5s">
                    <?php
                    if ( !dynamic_sidebar( 'news_portal_footer_sidebar-3' ) ):
                    endif;
                    ?>
                </div>
                <?php } ?>
                ...
                <div class="np-footer-widget wow fadeInLeft" data-wow-duration="2s">
                    <?php
                    if ( !dynamic_sidebar( 'news_portal_footer_sidebar-4' ) ):
                    endif;
                    the_tags()
                    ?>
                </div>
